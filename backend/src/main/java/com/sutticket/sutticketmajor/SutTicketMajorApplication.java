...
public class SutTicketMajorApplication {
	...
	ApplicationRunner init(CancelTicketRepository cancelTicketRepository,ReceiptRepository receiptRepository,
		...
		return args -> {
			...
			RangeAge ra1 = new RangeAge("12-17");
			RangeAge ra2 = new RangeAge("18-25");
			RangeAge ra3 = new RangeAge("26-30");
			RangeAge ra4 = new RangeAge("31-36");
			RangeAge ra5 = new RangeAge("37-45");
			RangeAge ra6 = new RangeAge("46-55");
			Stream.of(ra1,ra2,ra3,ra4,ra5,ra6).forEach(range -> {
			...
			Customer c4 = new Customer("Pontep Thaweesup", "asd", "asd",ra1,cr1,sex1);
